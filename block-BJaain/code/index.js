...
console.log(f1() === window); //false coz undefined
...
user.foo(); // 'Simple function call' false (use strict used)
let fun1 = user.foo1;
fun1(); // true
user.foo1(); // false - this points to user
...
object.double(); //this inside of outerFn double() , this = window * 3, [2,4,6]
object.doubleArrow(); //'this inside of outerFn doubleArrow()', this = obj, [2,4,6]
